...
@interface MEPulsingHaloLayer ()
@property (nonatomic, strong) CAAnimationGroup *animationGroup;
@end


@implementation MEPulsingHaloLayer
@synthesize repeatCount;

- (id)initWithRepeatCount:(float) aRepeatCount
{
    if ((self = [super init])) {
